...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown',
                                             options=[{'label': 'All Sites', 'value': 'ALL'}, {'label': 'VAFB SLC-4E', 'value': 'VAFB SLC-4E'}, {'label': 'KSC LC-39A', 'value': 'KSC LC-39A'}, {
...
def get_scatter_chart(entered_site, payload_value):
    if entered_site == 'ALL':
        ...
        site_data2 = spacex_df[spacex_df['Launch Site'] == entered_site]
        filtered_df2 = site_data2.groupby(['class', 'Booster Version Category'])[
            'Payload Mass (kg)'].count().reset_index()
